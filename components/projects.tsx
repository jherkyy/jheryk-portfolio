  ...
  n8n: [
    {
      ...
      problem: "Manually reviewing, classifying, and logging financial documents like invoices and receipts can be time-consuming and prone to errors, especially when documents come from various email or drive sources.",
      solution:
